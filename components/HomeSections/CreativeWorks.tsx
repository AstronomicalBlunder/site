    ...
    id="Creative Works">
      <div className="h-full w-[100vw] flex flex-col gap-5 md:gap-0 md:flex-row justify-evenly items-center text-xs lg:text-sm xl:text-base mb-64 lg:mb-0 ">
            ...
            <svg className="hidden md:block h-16 w-16 lg:h-24 lg:w-24" xmlns="http://www.w3.org/2000/svg"
                ...
                <h1 className="text-lg md:text-xl lg:text-2xl font-semibold text-sky-300">Some Writings</h1>
                <ul className="list-disc space-y-1">
                    <li>
                    ...
                    <li>
                        <InlineLink text='WhYuPenN' url='/pdfs/CreativeWriting/WhyCollegeJoke.pdf'/>: a joke essay I wrote out of frustration while in the depths of undergrad applications. Sorry UPenn.
                    </li>
                </ul>
            </div>
        </div>
